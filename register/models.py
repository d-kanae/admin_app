...
class Production(models.Model):
    products_name = models.ForeignKey(Products, verbose_name ="商品名", on_delete=models.CASCADE, related_name="商品")
...
class Sale(models.Model):
    products_name = models.ForeignKey(Products, verbose_name ="商品名", on_delete=models.CASCADE, related_name="商品名")
    production_date = models.ForeignKey(Production, verbose_name ="製造日", on_delete=models.CASCADE)
    best_before_duration = models.ForeignKey(Products, verbose_name ="賞味期間", on_delete=models.CASCADE, related_name="賞味期間")
    customer_name = models.ForeignKey(Customer, verbose_name ="販売先", on_delete=models.CASCADE, related_name="販売先")
